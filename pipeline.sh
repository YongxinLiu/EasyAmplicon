...
#!/bin/bash
    ...
    db=/c/public
    wd=/c/amplicon
    # 建议windows用户把软件目录 /c/public/win 永久添加环境变量
    PATH=$PATH:${db}/win
    cd ${wd}
...
## 1. 了解工作目录和起始文件
    ...
    # 	cd seq
    # 	# 示例下载单个文件并改名
    # 	wget -c ftp://download.big.ac.cn/gsa/CRA002352/CRR117575/CRR117575_f1.fq.gz -O KO1_1.fq.gz
    # 	# 按实验设计编号批量下载并改名，速度单位10M/s，家500K/s
    # 	head -n2 ../result/metadata.tsv

...
## 0. Software Installation (Appendix 1)
    ...
    # Refer to the official website for detailed instructions,https://docs.qiime2.org/2024.5/，Or the QIIME2 tutorial collection https://mp.weixin.qq.com/s/farGisfX3fVL_5WgXS8lIg
...
## 1. To install qiime2-amplicon-2024.5 
...
## Online installation of QIIME using Conda.
	
	# After installing Miniconda and opening a new terminal, make sure you’re running the latest version of conda (Optional but recomended):
	#conda update conda

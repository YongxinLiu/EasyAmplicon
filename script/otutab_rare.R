...
# 2021/4/12 1.1 Debug: Error in vegan::rrarefy(t(species), opts$depth) : function is meaningful only for integers (counts)；原因，输入数据不是整数；解决，输出数据取整
...
# 取整 
species = round(species, digits = 0)
